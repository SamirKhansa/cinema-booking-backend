...
//----------------------------------------------------------
$apis = [
    '/LogIn'         => ['controller' => 'ClientController', 'method' => 'LogIn'],
    '/SignUp'         => ['controller' => 'ClientController', 'method' => 'SignUp'],

    '/AddMovie'         => ['controller' => 'MoviesController', 'method' => 'insert_movie'],
    '/AllMovies'         => ['controller' => 'MoviesController', 'method' => 'get_all_movie_title_Image_url'],
    '/SingleMovie' => ['controller' => 'MoviesController', 'method' => 'get_Specific_movie'],
